window.renderGameView = function() {
    ...
    // AJOUT: Dessiner l'escalier dans la salle 8 ET la salle 100
    if (typeof currentRoomId !== 'undefined' && (currentRoomId === 8 || currentRoomId === 100)) {
        let sImg = assetsManager.images['stairs_down']; 
        if (currentRoomId === 100) { sImg = assetsManager.images['stairs_up'] || assetsManager.images['stairs_down']; }
        ...
        if (sImg && sImg.complete && sImg.naturalWidth > 0) {
            ...
            if (currentRoomId === 8 && !worldState.bossDefeated) { ctx.fillText("ESCALIER", sx + sw/2, sy + sh/2 - 10); ctx.fillStyle = '#e74c3c'; ctx.fillText("BLOQUÉ !", sx + sw/2, sy + sh/2 + 20); } 
            else { ctx.fillStyle = '#f1c40f'; ctx.fillText("ESCALIER", sx + sw/2, sy + sh/2 + 5); }
            ctx.textAlign = 'left';
        }
        ...
        if (currentRoomId === 100) { ctx.shadowColor = '#3498db'; ctx.shadowBlur = 30; ctx.strokeStyle = '#3498db'; ctx.lineWidth = 4; ctx.strokeRect(sx, sy, sw, sh); }
        ctx.restore();
    }
    ...
    // =========================================================================
    // DESSINER LA LUMIÈRE AVANT L'UI
    // =========================================================================
    ...
    // =========================================================================
    // DESSINER L'UI PAR DESSUS L'OMBRE POUR QU'ELLE SOIT 100% VISIBLE
    // =========================================================================
